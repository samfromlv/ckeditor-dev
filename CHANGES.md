...
* [#2870](https://github.com/ckeditor/ckeditor-dev/issues/2870): Added support for `margin-left` in lists pasted with [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
